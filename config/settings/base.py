...
MIGRATION_MODULES = {"sites": "cegs_portal.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "cegs_portal.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "cegs_portal.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
