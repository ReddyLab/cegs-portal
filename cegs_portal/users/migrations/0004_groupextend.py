    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiments', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=15, verbose_name='Associated Experiments'), default=list, size=None)),
