...
class Analysis:
    ...
    def load(self):
        ...
        results_file = open(self.results.file_metadata.filename)
        reader = csv.DictReader(results_file, delimiter=self.results.file_metadata.delimiter(), quoting=csv.QUOTE_NONE)
