...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "CREATE INDEX idx_reo_accession ON reo_sources_targets_sig_only (reo_accession)",
            "DROP INDEX reo_sources_targets_sig_only.idx_reo_accession",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_source_loc ON reo_sources_targets_sig_only USING GIST (source_loc)",
            "DROP INDEX reo_sources_targets_sig_only.idx_source_loc",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_target_loc ON reo_sources_targets_sig_only USING GIST (target_loc)",
            "DROP INDEX reo_sources_targets_sig_only.idx_target_loc",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_disc_facet ON reo_sources_targets_sig_only USING GIN (disc_facets)",
            "DROP INDEX reo_sources_targets_sig_only.idx_disc_facet",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_pval_asc ON reo_sources_targets_sig_only (((reo_facets->>'Raw p value')::numeric) ASC)",
            "DROP INDEX reo_sources_targets_sig_only.idx_pval_asc",
        ),
        migrations.RunSQL(
