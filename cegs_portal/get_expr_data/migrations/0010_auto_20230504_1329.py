...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            "DROP INDEX reo_sources_targets.idx_rst_reo_experiment",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_rst_reo_analysis ON reo_sources_targets (reo_analysis)",
            "DROP INDEX reo_sources_targets.idx_rst_reo_analysis",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_rst_source_chrom ON reo_sources_targets (source_chrom)",
            "DROP INDEX reo_sources_targets.idx_rst_source_chrom",
        ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            "CREATE INDEX idx_srs_target_chrom ON reo_sources_targets (target_chrom)",
            "DROP INDEX reo_sources_targets.idx_srs_target_chrom",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_srs_target_loc ON reo_sources_targets USING GIST (target_loc)",
            "DROP INDEX reo_sources_targets.idx_srs_target_loc",
        ),
        migrations.RunSQL(
            "CREATE INDEX idx_disc_facet ON reo_sources_targets USING GIN (disc_facets)",
            "DROP INDEX reo_sources_targets.idx_disc_facet",
        ),
    ]
