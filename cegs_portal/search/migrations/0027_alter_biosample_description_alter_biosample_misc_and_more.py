...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='dnafeature',
            name='closest_gene',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='closest_features', to='search.dnafeature'),
        ),
        migrations.AlterField(
            model_name='dnafeature',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, db_column='experiment_accession_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='search.experiment', to_field='accession_id'),
        ),
        migrations.AlterField(
            model_name='dnafeature',
        ...
        migrations.AlterField(
            model_name='dnafeature',
            name='ids',
            field=models.JSONField(blank=True, null=True, validators=[cegs_portal.search.models.validators.validate_gene_ids]),
        ),
        migrations.AlterField(
            model_name='dnafeature',
            name='misc',
        ...
        migrations.AlterField(
            model_name='dnafeature',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='search.dnafeature'),
        ),
        migrations.AlterField(
            model_name='dnafeature',
        ...
        migrations.AlterField(
            model_name='dnafeature',
            name='source',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='search.file'),
        ),
        migrations.AlterField(
            model_name='dnafeature',
            name='strand',
