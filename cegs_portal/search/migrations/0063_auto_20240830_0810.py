...
from cegs_portal.search.migrations.utils.facets import (
    delete_facet_value,
    get_or_create_facet,
    get_or_create_facet_value,
)
...
def add_new_facets(apps, schema_editor):
    ...
    source_type = get_or_create_facet(
        Facet, "Experiment Source Type", "The genome feature the experiment perturbs", "FacetType.CATEGORICAL"
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(fix_categorical_value, unfix_categorical_value),
    ]
