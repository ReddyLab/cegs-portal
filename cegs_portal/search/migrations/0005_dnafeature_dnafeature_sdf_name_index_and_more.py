    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accession_id', models.CharField(max_length=12, null=True, unique=True, validators=[cegs_portal.search.models.validators.validate_accession_id])),
                ...
                ('feature_type', models.CharField(choices=[(cegs_portal.search.models.dna_feature.DNAFeatureType['GENE'], 'gene'), (cegs_portal.search.models.dna_feature.DNAFeatureType['TRANSCRIPT'], 'transcript'), (cegs_portal.search.models.dna_feature.DNAFeatureType['EXON'], 'exon'), (cegs_portal.search.models.dna_feature.DNAFeatureType['CCRE'], 'ccre'), (cegs_portal.search.models.dna_feature.DNAFeatureType['DHS'], 'dhs')], default=cegs_portal.search.models.dna_feature.DNAFeatureType['GENE'], max_length=50)),
                ('feature_subtype', models.CharField(max_length=50, null=True)),
                ('misc', models.JSONField(null=True)),
                ('closest_gene', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='search.dnafeature')),
                ('facet_values', models.ManyToManyField(to='search.facetvalue')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='search.dnafeature')),
                ('source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='search.file')),
            ],
            options={
                'abstract': False,
            },
