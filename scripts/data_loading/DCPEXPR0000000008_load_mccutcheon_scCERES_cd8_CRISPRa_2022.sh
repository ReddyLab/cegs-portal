...
DHS_FILE=${DATA_DIR}/DCPEXPR0000000008_mccutcheon_scCERES_cd8_CRISPRa_2022/human_CD8_tcell_tf.grnas.dhs.tsv
FEATURES_FILE=${DATA_DIR}/DCPEXPR0000000008_mccutcheon_scCERES_cd8_CRISPRa_2022/features.tsv
CLOSEST_CCRE_FILE=${DATA_DIR}/DCPEXPR0000000008_mccutcheon_scCERES_cd8_CRISPRa_2022/closest_ccres.txt
