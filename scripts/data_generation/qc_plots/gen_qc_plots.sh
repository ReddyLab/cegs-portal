...
#     --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000002_klann_scCERES_K562_2021/supplementary_table_17_grna.de.markers.all.filtered.empirical_pvals.w_gene_info.csv \
...
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000003_klann_wgCERES_K562_2021/supplementary_table_13_DHS_summary_results.txt \
#     -x avg_logFC \
#     -y pValue \
#     -g geneSymbol
...
#     --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000003_klann_wgCERES_K562_2021/supplementary_table_13_DHS_summary_results.txt \
...
python3 ./scripts/data_generation/qc_plots/histogram.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000004/g_per_c.bin \
    ...
    --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000004_bounds_scCERES_mhc_ipsc_2021/ipsc.expect_cells.grna.de.markers.MAST.annotatedfull.final.update20220117.LRB.tsv \
...
python3 ./scripts/data_generation/qc_plots/histogram.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000005/c_per_g.bin \
    --header \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000005_bounds_scCERES_mhc_k562_2021/k562.run_negbinom.ncells_per_grna.txt \
    --bin-size 4
python3 ./scripts/data_generation/qc_plots/histogram.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000005/g_per_c.bin \
    --header \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000005_bounds_scCERES_mhc_k562_2021/k562.run_negbinom.ngrnas_per_cell.txt \
    --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000005_bounds_scCERES_mhc_k562_2021/k562.expect_cells.grna.de.markers.MAST.annotatedfull.final.update20220117.LRB.tsv \
...
python3 ./scripts/data_generation/qc_plots/histogram.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000006/c_per_g.bin \
    --header \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000006_bounds_scCERES_mhc_npc_2021/npc.run_negbinom.ncells_per_grna.txt \
    --bin-size 4
python3 ./scripts/data_generation/qc_plots/histogram.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000006/g_per_c.bin \
    --header \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000006_bounds_scCERES_mhc_npc_2021/npc.run_negbinom.ngrnas_per_cell.txt \
    --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000006_bounds_scCERES_mhc_npc_2021/npc.expect_cells.grna.de.markers.MAST.annotatedfull.final.update20220117.LRB.tsv \
...
python3 ./scripts/data_generation/qc_plots/volcano_plot.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000007/vpdata.bin \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000007_siklenka_atac-starr-seq_K562_2022/atacSTARR.ultra_deep.csaw.hg38.v10.common_file_formatted.txt \
    -x logFC \
    -y minusLog10PValue
...
#     --header \
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000007_siklenka_atac-starr-seq_K562_2022/npc.run_negbinom.ncells_per_grna.txt \
#     --bin-size 4
...
#     --header \
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000007_siklenka_atac-starr-seq_K562_2022/npc.run_negbinom.ngrnas_per_cell.txt \
#     --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000007_siklenka_atac-starr-seq_K562_2022/atacSTARR.ultra_deep.csaw.hg38.v10.common_file_formatted.txt \
...
python3 ./scripts/data_generation/qc_plots/volcano_plot.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000008/vpdata.bin \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000008_mccutcheon_scCERES_cd8_CRISPRa_2022/crispra.mast.volcano.all.min_thres_4.with_coords.txt \
    -x avg_log2FC \
    -y p_val \
    -g target_gene
...
#     --header \
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000008_mccutcheon_scCERES_cd8_CRISPRa_2022/npc.run_negbinom.ncells_per_grna.txt \
#     --bin-size 4
...
#     --header \
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000008_mccutcheon_scCERES_cd8_CRISPRa_2022/npc.run_negbinom.ngrnas_per_cell.txt \
#     --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000008_mccutcheon_scCERES_cd8_CRISPRa_2022/crispra.mast.volcano.all.min_thres_4.with_coords.txt \
...
python3 ./scripts/data_generation/qc_plots/volcano_plot.py --output ./cegs_portal/static_data/search/experiments/DCPEXPR00000009/vpdata.bin \
    --input ~/Documents/ccgr_portal/data/DCPEXPR00000009_mccutcheon_scCERES_cd8_CRISPRi_2022/crispri.mast.volcano.all.min_thres_4.with_coords.txt \
    -x avg_log2FC \
    -y p_val \
    -g target_gene
...
#     --header \
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000009_mccutcheon_scCERES_cd8_CRISPRi_2022/npc.run_negbinom.ncells_per_grna.txt \
#     --bin-size 4
...
#     --header \
#     --input ~/Documents/ccgr_portal/data/DCPEXPR00000009_mccutcheon_scCERES_cd8_CRISPRi_2022/npc.run_negbinom.ngrnas_per_cell.txt \
#     --bin-size 1
python3 ./scripts/data_generation/qc_plots/qq_plot.py --input ~/Documents/ccgr_portal/data/DCPEXPR00000009_mccutcheon_scCERES_cd8_CRISPRi_2022/crispri.mast.volcano.all.min_thres_4.with_coords.txt \
