...
python manage.py shell -c "from os.path import join; from scripts.data_generation import gen_experiment_coverage_viz; gen_experiment_coverage_viz.run(join(\"$OUTPUT_DIR\", \"level1.json\"), \"$EXPERIMENT\", \"$GENOME\")"
